...
<!-- ID -->
	<div class="form-group col-xs-6">
		...
		<input type="text" name="pro_id" class="form-control" disabled value="<?php echo $produit->pro_id; ?>" readonly="readonly">
		<!-- readonly="readonly" fige la valeur, pas possiblité de la modifier  -->
	</div>
<!-- reference -->	
	<div class="form-group col-xs-6">
		<label for="pro_ref">Référence</label>
		<input type="text" name="pro_ref" class="form-control" disabled value="<?php echo $produit->pro_ref; ?>">
	</div>
<!-- categorie -->				
	<div class="form-group col-xs-6">
		<label for="pro_cat_id">Catégorie</label>
		<input type="text" name="pro_cat_id" class="form-control" disabled value="<?php echo $produit->pro_cat_id; ?>">
	</div>
<!-- libelle -->	
	<div class="form-group col-xs-6">
		<label for="pro_libelle">Libellé</label>
		<input type="text" name="pro_libelle" class="form-control" disabled value="<?php echo $produit->pro_libelle; ?>">
	</div>
<!-- description -->		
	<div class="form-group col-xs-6">
		<label for="pro_description">Description</label>
		<textarea name="pro_description" class="form-control" disabled cols="150" rows=auto><?php echo $produit->pro_description; ?></textarea>
	</div>
<!-- prix -->
	<div class="form-group col-xs-6" class="text-right">
		<label for="pro_prix">Prix</label>
		<input type="text" name="pro_prix" class="form-control" disabled value="<?php echo $produit->pro_prix; ?>">		
	</div>
<!-- stock -->		
	<div class="form-group col-xs-6">
		<label for="pro_stock">Stock</label>
		<input type="text" name="pro_stock" class="form-control" disabled value="<?php echo $produit->pro_stock; ?>">
	</div>
<!-- couleur -->
	<div class="form-group col-xs-6">
		<label for="pro_couleur">Couleur</label>
		<input type="text" name="pro_couleur" class="form-control" disabled value="<?php echo $produit->pro_couleur; ?>">
	</div>
...
<!-- valider -->	
    <br><br>
     <center><a href="liste.php"><input type="button" value="retour" name="retour" class="btn btn-info"></a></center>
